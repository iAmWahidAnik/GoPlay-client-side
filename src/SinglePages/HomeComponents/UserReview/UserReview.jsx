        ...
        <div className='bg-violet-500 my-20 rounded-lg shadow-lg'>
            ...
            <div className='flex flex-col lg:flex-row gap-10 p-10 text-center'>
                <div className='lg:w-1/2'>
                    <p className='text-white'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure molestiae nobis at fugiat voluptates nihil maxime magnam cum facere, in aspernatur fuga qui corrupti exercitationem cumque soluta quod? Perferendis, nisi.</p>
